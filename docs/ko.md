...
* **멀티 사이트 지원**: **YouTube**와 **Bilibili**(`www.bilibili.com`)를 모두 지원하며, 두 사이트에서 동일한 존과 액션을 사용할 수 있습니다.
...
* **인터페이스 언어**: 브라우저 언어에 따라 자동 전환(영어, 번체·간체 중국어, 일본어, 한국어, 포르투갈어, 스페인어). 해당 없으면 영어.
